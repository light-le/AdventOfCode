...
for output, input in test_output_input.items():
    cal_output = solve_part1(input)
    assert output == cal_output, f'Expecting {output}, got {cal_output} instead.'


print('Tests passed, the actual output of part1 of this problem is')
with open('2019/day3.txt', 'r') as f:
    lines = f.readlines()
    act_part1_output = solve_part1(lines)
    print(act_part1_output)